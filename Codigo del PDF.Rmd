...
```{r Grafico Univariante 4, echo=FALSE, fig.align='center', out.width='80%', results='hide'}
...
```{r Grafico Bivariante 3 y 4, echo=FALSE, fig.align='center', out.width='80%'}
...
ggplot(NBA, aes(x = FTM, y = PTS, color = Cuatrienal)) +
  geom_point(alpha = 0.6) +
  labs(title = "Relación entre Tiros Libres Anotados y Puntos",
